...
//                            }
                            ...
                            startActivity(Intent(this@ServiceLogMasterCameraActivity,ServiceLogMasterImagePreviewActivity::class.java))
                        }
                        1 -> {
                            val file = File(
                                externalMediaDirs.firstOrNull(),
